// Modern Forms PHP template – pasted code is inserted at <!-- INSERT CODE HERE -->

export const MODERN_FORMS_FORM_PLACEHOLDER = '<!-- INSERT CODE HERE -->'
